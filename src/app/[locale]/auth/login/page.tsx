      ...
      >
        <div className="glass-card rounded-3xl p-8 space-y-6">
          <div className="text-center space-y-2">
            ...
            <h1 className="text-2xl font-bold">{dict.auth.login}</h1>
          </div>
          ...
          <div className="relative">
            ...
            <div className="relative flex justify-center text-xs"><span className="px-2 bg-surface text-gray-500">or</span></div>
          </div>

          <div className="grid grid-cols-2 gap-3">
            <Button variant="outline" size="sm" onClick={() => signIn("google", { callbackUrl: `/${locale}` })}>
            ...
            <Button variant="outline" size="sm" onClick={() => signIn("github", { callbackUrl: `/${locale}` })}>
          ...
          <p className="text-center text-sm text-gray-500">
            {dict.auth.noAccount}{" "}
            <Link href={`/${locale}/auth/register`} className="text-aether-400 hover:text-aether-300 transition-colors">
              {dict.auth.register}
            </Link>
          </p>
        </div>
